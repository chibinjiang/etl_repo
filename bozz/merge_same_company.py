...
def query_bozz(name):
    ...
    import os
    curl = f"""curl -H 'Host: www.zhipin.com' -H 'Cookie: __zp__pub__=; Hm_lpvt_194df3105ad7148dcf2b98a91b5e727a=1594644343; Hm_lvt_194df3105ad7148dcf2b98a91b5e727a=1594644343; __zp_stoken__=4f4faPC5UeCopNwgfajxhAWJiBVhiem9MUyEQNRVLKR05Yh1FFFgiUiBeAGRmMnUXD39CJHRKNzoXF2BVGn0SOA8Xc3M6XXgUfksvRDJsWF9NGDBbFzBAJTdOKQwJJhwdTUYHW3tDSE0JBWE%3D; __a=1077175.1594644340..1594644340.1.1.1.1; __c=1594644340; __g=-; __l=l=%2Fwww.zhipin.com%2Fjob_detail%2F%3Fquery%3D%25E4%25B9%2590%25E4%25BF%25A1%25E5%259C%25A3%25E6%2596%2587%26city%3D100010000%26industry%3D%26position%3D&r=&friend_source=0' -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8' -H 'user-agent: Mozilla/5.0 (iPhone; CPU iPhone OS 12_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/7.0.14(0x17000e24) NetType/WIFI Language/en' -H 'accept-language: en-us' --compressed 'https://www.zhipin.com/job_detail/?query={name}&city=100010000&industry=&position='"""
    response = os.popen(curl).read()
    if len(response) < 51402:
